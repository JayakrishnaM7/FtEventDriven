...
public class FtBankTransferNonupiApi {

	Logger logger = LoggerFactory.getLogger(FtBankTransferNonupiApi.class);

	@Autowired
	FtBankTransferNonupiI ftBankTransferNonupiI;
	@Autowired
	FTinConsumer fTinConsumer;
	
	@PostMapping(path = "/FtBankTransferNonupi")
	public ResponseEntity<?> fundtransferAccountToAccount(@RequestBody FtRq ftRq) throws Exception {
		ResponseEntity<?> rs=ftBankTransferNonupiI.ftBankTransferNonupiprocess(ftRq);
	...
	@PostMapping(path = "/FtLoanBankTransfer")
	public ResponseEntity<?> fundtransferLoanAccount(@RequestBody FtRq ftRq) throws Exception {
		ResponseEntity<?> rs=ftBankTransferNonupiI.ftBankTransferNonupiprocess(ftRq);
		Account2accountRs account2accountRs=new Account2accountRs();
		Thread.sleep(2000);
		logger.info("rs.getStatusCode() :"+rs.getStatusCode());
	...
	@PostMapping(path = "/FtBankDepostTransfer")
	public ResponseEntity<?> fundtransferDepositAccount(@RequestBody FtRq ftRq) throws Exception {
		ResponseEntity<?> rs=ftBankTransferNonupiI.ftBankTransferNonupiprocess(ftRq);
		Account2accountRs account2accountRs=new Account2accountRs();
		Thread.sleep(2000);
		logger.info("rs.getStatusCode() :"+rs.getStatusCode());
	...
	@PostMapping(path = "/FtInsuranceTransfer")
	public ResponseEntity<?> fundtransferInsuranceAccount(@RequestBody FtRq ftRq) throws Exception {
		ResponseEntity<?> rs=ftBankTransferNonupiI.ftBankTransferNonupiprocess(ftRq);
		Account2accountRs account2accountRs=new Account2accountRs();
		Thread.sleep(2000);
		logger.info("rs.getStatusCode() :"+rs.getStatusCode());
	...
	@PostMapping(path = "/FtMutualFundTransfer")
	public ResponseEntity<?> fundtransferMutualFundsToAccount(@RequestBody FtRq ftRq) throws Exception {
		ResponseEntity<?> rs=ftBankTransferNonupiI.ftBankTransferNonupiprocess(ftRq);
		Account2accountRs account2accountRs=new Account2accountRs();
		Thread.sleep(2000);
		logger.info("rs.getStatusCode() :"+rs.getStatusCode());
	...
	@PostMapping(path = "/FtDonationTransfer")
	public ResponseEntity<?> fundtransferDonationAccountToAccount(@RequestBody FtRq ftRq) throws Exception {
		ResponseEntity<?> rs=ftBankTransferNonupiI.ftBankTransferNonupiprocess(ftRq);
		Account2accountRs account2accountRs=new Account2accountRs();
		Thread.sleep(2000);
		logger.info("rs.getStatusCode() :"+rs.getStatusCode());
	...
	@PostMapping(path = "/FtRentalTransfer")
	public ResponseEntity<?> fundtransferRentalAccountToAccount(@RequestBody FtRq ftRq) throws Exception {
		ResponseEntity<?> rs=ftBankTransferNonupiI.ftBankTransferNonupiprocess(ftRq);
		Account2accountRs account2accountRs=new Account2accountRs();
		Thread.sleep(2000);
		logger.info("rs.getStatusCode() :"+rs.getStatusCode());
	...
	@PostMapping(path = "/FtHousingSocietyTransfer")
	public ResponseEntity<?> fundtransferHousingsocietyAccountToAccount(@RequestBody FtRq ftRq) throws Exception {
		ResponseEntity<?> rs=ftBankTransferNonupiI.ftBankTransferNonupiprocess(ftRq);
		Account2accountRs account2accountRs=new Account2accountRs();
		Thread.sleep(2000);
		logger.info("rs.getStatusCode() :"+rs.getStatusCode());
