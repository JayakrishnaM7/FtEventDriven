...
public class FtRepeatPayment {
	Logger logger = LoggerFactory.getLogger(FtBankTransferNonupiApi.class);
	@Autowired
	FtRepeatPaymentI ftRepeatPaymentI;
	
	@PostMapping(path = "/ftRepeatPayment")
	public ResponseEntity<?> ftRepeatPayment(@RequestBody FtRq ftRq) throws Exception {
		ResponseEntity<?> rs=ftRepeatPaymentI.ftRepeatPaymentIprocess(ftRq);
	...
	@PostMapping(path = "/ftRepeatPaymentselfAcc")
	public ResponseEntity<?> ftRepeatPaymentSelfAccount(@RequestBody FtRq ftRq) throws Exception {
		ResponseEntity<?> rs=ftRepeatPaymentI.ftRepeatPaymentIprocess(ftRq);
		Account2accountRs account2accountRs=new Account2accountRs();
		Thread.sleep(2000);
		logger.info("rs.getStatusCode() :"+rs.getStatusCode());
	...
	@PostMapping(path = "/ftRepeatPaymentotherAcc")
	public ResponseEntity<?> ftRepeatPaymentotherAccount(@RequestBody FtRq ftRq) throws Exception {
		ResponseEntity<?> rs=ftRepeatPaymentI.ftRepeatPaymentIprocess(ftRq);
		Account2accountRs account2accountRs=new Account2accountRs();
		Thread.sleep(2000);
		logger.info("rs.getStatusCode() :"+rs.getStatusCode());
	...
	@PostMapping(path = "/ftRepeatPaymentLinkedAcc")
	public ResponseEntity<?> ftRepeatPaymentLinkedAccount(@RequestBody FtRq ftRq) throws Exception {
		ResponseEntity<?> rs=ftRepeatPaymentI.ftRepeatPaymentIprocess(ftRq);
		Account2accountRs account2accountRs=new Account2accountRs();
		Thread.sleep(2000);
		logger.info("rs.getStatusCode() :"+rs.getStatusCode());
	...
	@PostMapping(path = "/ftRepeatPaymentBillpayAcc")
	public ResponseEntity<?> ftRepeatPaymentBillpayAccount(@RequestBody FtRq ftRq) throws Exception {
		ResponseEntity<?> rs=ftRepeatPaymentI.ftRepeatPaymentIprocess(ftRq);
		Account2accountRs account2accountRs=new Account2accountRs();
		Thread.sleep(2000);
		logger.info("rs.getStatusCode() :"+rs.getStatusCode());
	...
	@PostMapping(path = "/ftRepeatPaymentUpipayAcc")
	public ResponseEntity<?> ftRepeatPaymentUpiAccount(@RequestBody FtRq ftRq) throws Exception {
		ResponseEntity<?> rs=ftRepeatPaymentI.ftRepeatPaymentIprocess(ftRq);
		Account2accountRs account2accountRs=new Account2accountRs();
		Thread.sleep(2000);
		logger.info("rs.getStatusCode() :"+rs.getStatusCode());
